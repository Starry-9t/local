...
import tally.adapter.AccountAdapter;
import tally.db.AccountBean;
import tally.db.DBManager;
import tally.utils.BudgetDialog;
import tally.utils.MoreDialog;



public class MainActivity3 extends AppCompatActivity implements View.OnClickListener {
    ListView todayLv;  //展示今日的ListView（今日！！)
    ImageView searchIv;
    Button editBtn;
    ImageButton moreBtn;
    //声明数据源
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageButton imageButton = (ImageButton) findViewById(R.id.ib_shubiao);
    ...
    private void setLVLongClickListener() {
        todayLv.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                int pos = position - 1;
                AccountBean clickBean = mDatas.get(pos);  //获取被点击的这条信息
...
//    设置显示运算剩余
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.main_iv_search://点击了搜索，跳转界面
                Intent it = new Intent(this, SearchActivity.class);  //跳转界面
                startActivity(it);
                break;
            case R.id.main_btn_edit://点击了编辑，记账
                Intent it1 = new Intent(this, RecordActivity.class);  //跳转界面
                startActivity(it1);
                break;
            case R.id.main_btn_more://点击了更多，弹出设置等信息
                MoreDialog moreDialog = new MoreDialog(this);
                moreDialog.show();
                moreDialog.setDialogSize();
                break;
            case R.id.item_mainlv_top_tv_budget://点击预算，弹出预算界面
                showBudgetDialog();
                break;
            case R.id.item_mainlv_top_iv_hide://点击了密文，数据变成...
                // 切换TextView明文和密文
                toggleShow();
                break;
        }
